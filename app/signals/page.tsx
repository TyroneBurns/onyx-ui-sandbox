      ...
      <section className="space-y-8">
        ...
        <div className="grid gap-4 xl:grid-cols-2">
          ...
          <Card className="p-6">
            ...
            <div className="mt-6 rounded-[24px] border border-emerald-500/20 bg-emerald-500/8 p-5">
              <p className="text-sm leading-7 text-slate-200">
                The ONYX stack is currently favouring cleaner continuation setups after reducing sensitivity to low-quality regime changes.
                Entries below the tightened confidence floor are now blocked rather than allowed to degrade overall expectancy.
              </p>
            </div>
          </Card>
        </div>
